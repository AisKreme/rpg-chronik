...
export async function deleteChronikEntry(entry) {
  ...
  await safeExportPDF(pageEl, `Chronik-Eintrag-${entry.id}.pdf`, entry)
...
export async function deleteNSCEntry(entry) {
  ...
  await safeExportPDF(pageEl, `Chronik-NSC-${entry.id}.pdf`, entry)
...
export async function deleteMapEntry(entry) {
  ...
  await safeExportPDF(pageEl, `Chronik-Karte-${entry.id}.pdf`, entry)
